    ...
    >
      <form className="w-11/12 flex items-center justify-center flex-col p-4 pt-[3rem] gap-4">
        ...
        <input
          ...
          className="w-6/12 border-b-2 border-[white] bg-transparent pb-3 text-[white] outline-none mb-4"
        />
        <input
          type="text"
        ...
        <input
          ...
          className="w-6/12 border-b-2 border-[white] bg-transparent pb-3 text-[white] outline-none mb-4"
        />
        <span className="flex items-center justify-start w-6/12 gap-2 text-[white]">
          <input type="radio" />{" "}
          <p>
