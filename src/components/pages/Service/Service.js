      ...
      <div className="w-11/12 grid grid-cols-3 gap-4">
        ...
        <div className="col-span-2 flex items-center justify-center flex-col gap-4">
          <div className="flex items-start justify-start gap-2 flex-col">
            ...
            <p>
              Make your dream wedding a reality. We handle everything from décor
              and venues to catering and coordination. Enjoy a magical day that
          ...
          <div className="flex items-start justify-start gap-2 flex-col">
            ...
            <p>
              ...
              corporate event. From conferences to team-building activities, we
              ensure your event reflects your brand and values.
            </p>
          </div>{" "}
          <div className="flex items-start justify-start gap-2 flex-col">
            <h3 className="text-mainHeading text-normalHeading font-normalHeading">
            ...
            <p>
              We specialize in government functions, ensuring every detail meets
              the highest standards. Whether it's an official ceremony or a
              community outreach program, we deliver with expertise and
              discretion.
            </p>
          </div>
        </div>
        ...
        <div className="col-span-2 flex items-center justify-center flex-col gap-4">
          <div className="flex items-start justify-start gap-2 flex-col">
            ...
            <p>
              ...
              anniversaries, galas, or fundraisers, we turn your vision into an
          ...
          <div className="flex items-start justify-start gap-2 flex-col">
            ...
            <p>
              No matter the occasion, our dedicated team will handle everything
              to ensure a seamless and stress-free experience. Share your vision
              with us, and we'll make it unforgettable.
            </p>
