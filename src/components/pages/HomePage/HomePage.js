                ...
                <div className="grid grid-cols-2 mobile:flex mobile:flex-col mobile:gap-4">
                  ...
                  <div className="border-l-2 border-[#454545] flex flex-col gap-1">
                    ...
                    <p className="p-2 text-textColor leading-9">
                      At Evaga Entertainment Pvt Ltd, we believe that every
                      event is a unique story waiting to be told. With our
                      expertise and passion for creating memorable moments, we
                      transform your vision into reality. Our comprehensive
                      range of services and dedicated team ensure that every
